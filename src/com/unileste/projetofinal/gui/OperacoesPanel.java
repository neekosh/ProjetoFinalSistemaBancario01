...
public class OperacoesPanel extends javax.swing.JPanel {
    private Banco banco;
    public OperacoesPanel(Banco banco) {
        initComponents();
        this.banco = banco;
    }

    private void carregarHistorico(String numeroConta) {
    try {
        List<String> extrato = banco.obterExtrato(numeroConta);

        DefaultTableModel modelo = (DefaultTableModel) tabelaHistorico.getModel();
        modelo.setRowCount(0);

        for (String linha : extrato) {
            modelo.addRow(new Object[]{ linha });
        }
    ...
    private void initComponents() {
        ...
        txtDestinoTransferencia = new javax.swing.JTextField();
        ...
        txtDestinoTransferencia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDestinoTransferenciaActionPerformed(evt);
            }
        });
        ...
        btnListarHistoricoTransacoes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnListarHistoricoTransacoesActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtDestinoTransferencia, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(34, 34, 34)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(tituloContaDestinoTransferencia)
                    .addComponent(txtDestinoTransferencia, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(27, 27, 27)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void txtDestinoTransferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDestinoTransferenciaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDestinoTransferenciaActionPerformed
    ...
    private void btnRealizarSaqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarSaqueActionPerformed
       try {
        ...
        double valor = Double.parseDouble(txtValorDepositoSaque.getText().trim());
        ...
        JOptionPane.showMessageDialog(this, "Erro ao sacar: " + e.getMessage());
    }
    ...
    private void btnRealizarDepositoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarDepositoActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Erro ao depositar: " + e.getMessage());
    }
    ...
    private void btnRealizarTransferenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarTransferenciaActionPerformed
        try {
        String origem = txtOrigemTransferencia.getText().trim();
        String destino = txtDestinoTransferencia.getText().trim();
        double valor = Double.parseDouble(txtValorTransferencia.getText().trim());

        banco.realizarTransferencias(origem, destino, valor);
    ...
    private void btnListarHistoricoTransacoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarHistoricoTransacoesActionPerformed
      try {
        String numero = txtNumeroConta.getText().trim();

        List<String> extrato = banco.obterExtrato(numero);

        DefaultTableModel modelo = (DefaultTableModel) tabelaHistorico.getModel();
        modelo.setRowCount(0); // limpa antes de preencher
    ...
    }//GEN-LAST:event_btnListarHistoricoTransacoesActionPerformed
    ...
    private javax.swing.JTextField txtDestinoTransferencia;
